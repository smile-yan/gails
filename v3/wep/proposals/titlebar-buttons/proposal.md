# Gails Enhancement Proposal (WEP)

## Customising Window Controls in Gails
...
This is a proposal for an API to control the appearance and functionality of window controls in Gails.
...
import (
	"github.com/wailsapp/gails/v3/pkg/application"
	"github.com/wailsapp/gails/v3/pkg/w32"
)
...
This feature will be maintained and supported by the Gails developers.
