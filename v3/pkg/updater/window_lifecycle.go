...
const (
	EventWindowReady = "gails:updater:window:ready"
	EventUserInstall = "gails:updater:user:install"
	EventUserSkip    = "gails:updater:user:skip"
	EventUserRemind  = "gails:updater:user:remind"
	EventUserCancel  = "gails:updater:user:cancel"
	EventUserRestart = "gails:updater:user:restart"
)
