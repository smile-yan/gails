...
func init() {
	...
	// See: https://github.com/gailsapp/gails/issues/4985
...
func windowShow(window pointer) {
	...
	// is fully realized. See: https://github.com/gailsapp/gails/issues/4769
...
func windowSetHTML(webview pointer, html string) {
	webkitWebViewLoadAlternateHTML(webview, html, "gails://", nil)
}
