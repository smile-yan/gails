...
```go
import "github.com/wailsapp/gails/v3/pkg/application"
import "github.com/wailsapp/gails/v3/pkg/services/badge"
import "image/color"
...
#### JS
```js
import {SetBadge} from "../bindings/github.com/wailsapp/gails/v3/pkg/services/badge/service";
...
#### JS
```js
import {SetCustomBadge} from "../bindings/github.com/wailsapp/gails/v3/pkg/services/badge/service";
...
#### JS
```js
import {RemoveBadge} from "../bindings/github.com/wailsapp/gails/v3/pkg/services/badge/service";
