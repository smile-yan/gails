...
This example demonstrates running a Gails application in server mode - without a native GUI window.

## What is Server Mode?

Server mode allows you to run your Gails application as a pure HTTP server. This enables:

- **Docker/Container deployments** - Deploy your Gails app without X11/Wayland dependencies
- **Server-side rendering** - Use your Gails app as a web server
...
gails3 task build:server

# Build and run
gails3 task run:server
```
