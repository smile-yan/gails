...
func main() {
	app := clir.NewCli("gails", "The Gails3 CLI", "v3")
...
func printFooter() {
	if !commands.DisableFooter {
		docsLink := term.Hyperlink("https://v3.gails.io/getting-started/your-first-app/", "gails3 docs")
		...
		linkText := term.Hyperlink("https://github.com/sponsors/leaanthony", "gails3 sponsor")
