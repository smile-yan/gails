...
(function () {
  ...
  Events.On("gails:updater:update-available", function (e) {
  ...
  Events.On("gails:updater:download-started",  function () { setState("Downloading…"); });
  Events.On("gails:updater:download-progress", function (e) {
  ...
  Events.On("gails:updater:verifying",  function () { setState("Verifying…"); });
  Events.On("gails:updater:installing", function () { setState("Installing…"); });
  Events.On("gails:updater:update-ready", function () { setState("Ready to restart"); });
  Events.On("gails:updater:error",      function (e) {
  ...
  Events.Emit("gails:updater:window:ready");
})();
</script>
</body></html>`
