...
The Gails CLI is a command line tool that allows you to create, build and run Gails applications.
...
The `generate` command is used to generate resources and assets for your Gails project.
...
```bash
gails3 generate icon -input myicon.png -sizes "32,64,128" -windowsFilename myicon.ico -macFilename myicon.icns       
```
...
| `-out`      | string | The output filename for the syso file      | `gails.exe.syso` |
