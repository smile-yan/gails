...
type gailsError struct {
	cause           error
	msg             string
	errorType       ErrorType
}

func (w *gailsError) Cause() error          { return w.cause }
func (w *gailsError) Error() string {
...
func (w *gailsError) Msg() string           { return w.msg }
func (w *gailsError) ErrorType() ErrorType  { return w.errorType }
func (w *gailsError) Unwrap() error  { return w.cause }
