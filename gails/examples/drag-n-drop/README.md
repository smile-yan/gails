...
This example demonstrates how to handle files being dragged from the operating system (Finder, Explorer, file managers) into a Gails application.
...
When files are dragged over a valid drop target, Gails adds the `file-drop-target-active` class:
