...
func GetReleaseNotes(tagVersion string, noColour bool) string {
	resp, err := http.Get("https://api.github.com/repos/gailsapp/gails/releases/tags/" + url.PathEscape(tagVersion))
	if err != nil {
...
func GetVersionTags() ([]*SemanticVersion, error) {
	...
	resp, err := http.Get("https://api.github.com/repos/gailsapp/gails/tags")
	if err != nil {
		return result, err
	}
	body, err := io.ReadAll(resp.Body)
