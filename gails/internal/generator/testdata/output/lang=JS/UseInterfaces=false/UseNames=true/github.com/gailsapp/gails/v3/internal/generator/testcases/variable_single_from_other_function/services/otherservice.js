 ...
 */
export function Yay() {
    return $Call.ByName("github.com/gailsapp/gails/v3/internal/generator/testcases/variable_single_from_other_function/services.OtherService.Yay").then(/** @type {($result: any) => any} */(($result) => {
