...
export function Yay(): $CancellablePromise<$models.Address | null> {
    return $Call.ByName("github.com/gailsapp/gails/internal/generator/testcases/variable_single_from_other_function/services.OtherService.Yay").then(($result: any) => {
