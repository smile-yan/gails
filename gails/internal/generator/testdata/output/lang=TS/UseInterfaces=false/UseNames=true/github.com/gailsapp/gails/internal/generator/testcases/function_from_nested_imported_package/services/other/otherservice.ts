...
export function Yay(): $CancellablePromise<$models.Address | null> {
    return $Call.ByName("github.com/gailsapp/gails/internal/generator/testcases/function_from_nested_imported_package/services/other.OtherService.Yay").then(($result: any) => {
