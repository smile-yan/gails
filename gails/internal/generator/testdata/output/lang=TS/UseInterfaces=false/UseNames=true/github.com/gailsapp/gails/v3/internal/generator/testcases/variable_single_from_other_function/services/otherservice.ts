...
export function Yay(): $CancellablePromise<$models.Address | null> {
    return $Call.ByName("github.com/gailsapp/gails/v3/internal/generator/testcases/variable_single_from_other_function/services.OtherService.Yay").then(($result: any) => {
