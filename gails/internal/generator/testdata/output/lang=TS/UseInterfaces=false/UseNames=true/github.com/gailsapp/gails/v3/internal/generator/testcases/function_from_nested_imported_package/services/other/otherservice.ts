...
export function Yay(): $CancellablePromise<$models.Address | null> {
    return $Call.ByName("github.com/gailsapp/gails/v3/internal/generator/testcases/function_from_nested_imported_package/services/other.OtherService.Yay").then(($result: any) => {
