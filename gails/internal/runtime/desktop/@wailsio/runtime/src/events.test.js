...
const dispatchGailsEvent = window._gails.dispatchGailsEvent;
...
describe("Off", () => {
  ...
  it("should cancel all event listeners for a single type", () => {
    Off('a');
    dispatchGailsEvent({ name: 'a' });
    dispatchGailsEvent({ name: 'b' });
    dispatchGailsEvent({ name: 'c' });
